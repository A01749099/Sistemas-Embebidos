...
class WhatsAppNotifier:
    def _init_(self, 
                 token: str = 'EAAHvZBdqwRFYBO29UuIhdjohQ9esHeEGiNPXd8ZBQz3LUU9ZCepGkB2mUETeMzYLIkLJExhKY3j6n81WLnezBfwhW3YOJYIJYdI6TZC6tXxLxMKyYxQqyixcUcFxZCXE0csrXIybsfyE6IGd5Bx1dIOijQkqILeI5X7vZA57rjmjZAb2GGPpIUpgOAe2ZCo6fsC5reQYecA0ciL14HY6f8Hiwl7KQPMZD', 
        ...
        """
        Inicializa el notificador de WhatsApp con configuraciÃ³n flexible.
        """
        logging.basicConfig(
            level=logging.INFO,
    ...
    def _validate_phone_number(self, phone_number: str) -> bool:
        """Valida el formato de nÃºmero telefÃ³nico mexicano"""
        cleaned_number = ''.join(filter(str.isdigit, phone_number))
        
        if len(cleaned_number) != 12 or not cleaned_number.startswith('52'):
            logging.error(f"NÃºmero invÃ¡lido: {phone_number}")
            return False
        return True

    def _get_destination_numbers(self) -> List[str]:
        """Obtiene los nÃºmeros de telÃ©fono"""
        # Si ya se proporcionaron nÃºmeros, Ãºsalos
        if self.destination_numbers:
            return self.destination_numbers
        
        # Si se proporcionÃ³ URL de Google Sheets, intenta obtener nÃºmeros de ahÃ­
        if self.google_sheet_url and self.credentials_path:
            try:
                ...
                # Obtiene nÃºmeros de la tercera columna, saltando encabezados
                ...
                logging.info(f"NÃºmeros de telÃ©fono encontrados: {formatted_numbers}")
                ...
                logging.error(f"Error al obtener nÃºmeros de telÃ©fono: {e}")
                return []
        
        logging.error("No se proporcionaron nÃºmeros de telÃ©fono ni configuraciÃ³n de Google Sheets")
        return []
    ...
    def send_whatsapp_template(self, 
        ...
        """EnvÃ­a un mensaje de plantilla por WhatsApp"""
    ...
    def send_messages(self, 
        ...
        """
        EnvÃ­a mÃºltiples plantillas de mensajes a los nÃºmeros de telÃ©fono
        """
...
def initialize_cameras():
    ...
    working_cameras = []
    for i in range(10):  # Buscar en mÃ¡s Ã­ndices
    ...
    cap2 = cv2.VideoCapture(working_cameras[1])  # Cambiar a Ã­ndice siguiente
...
def main():
    ...
    # Nuevas variables para rastrear detecciÃ³n de caras conocidas
    ...
    try:
        ...
        while True:
            ...
            # LÃ³gica para pausar la detecciÃ³n cuando hay caras conocidas
            ...
            # Solo continÃºa con la lÃ³gica si NO estÃ¡ en pausa
                ...
                if time_since_last_photo >= required_interval:
                    ...
                    if should_take_photo:
                        ...
                        for i, frame in enumerate([frame1, frame2]):
                            photo_path = f"{photo_reason}cam{i+1}{photo_count}.jpg"
